      ...
      <div className="container px-12 mx-auto md:flex md:items-center">
        <ul className="hidden md:flex flex-auto space-x-6 items-center">
          ...
          <li className=" rounded-full">
           ...
           <img src="https://img.freepik.com/free-photo/dreamy-young-woman-sunglasses-looking-front_197531-16739.jpg?w=2000" className="object-contain rounded-full w-16 h-32" />
          </li>
